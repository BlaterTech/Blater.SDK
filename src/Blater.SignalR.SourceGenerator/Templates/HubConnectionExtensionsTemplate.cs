...
public sealed class HubConnectionExtensionsTemplate
{
    private const string TemplateText1 = """
                                         // <auto-generated>
                                         // THIS (.cs) FILE IS GENERATED BY Blater.SignalR.SourceGenerator
                                         // </auto-generated>
                                         #nullable enable
                                         ...
                                         namespace Blater.SignalR.SourceGenerator
                                         {
                                             internal static partial class HubConnectionExtensions
                                             {
                                                 public static THub CreateHubProxy<THub>(this global::Microsoft.AspNetCore.SignalR.Client.HubConnection connection, global::System.Threading.CancellationToken cancellationToken = default)
                                                 {
                                                     ...
                                                     if (factory is null)
                                                     {
                                                         throw new global::System.InvalidOperationException($"Failed to create a hub proxy. Blater.SignalR.SourceGenerator did not generate source code to create a hub proxy, which type is {typeof(THub)}.");
                                                     }
                                                 ...
                                                 public static global::System.IDisposable Register<TReceiver>(this global::Microsoft.AspNetCore.SignalR.Client.HubConnection connection, TReceiver receiver)
                                                 {
                                                     ...
                                                     if (binder is null)
                                                     {
                                                         throw new global::System.InvalidOperationException($"Failed to register a receiver. Blater.SignalR.SourceGenerator did not generate source code to register a receiver, which type is {typeof(TReceiver)}.");
                                                     }
