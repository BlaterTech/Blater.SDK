...
public static class TypeValidator
{
        ...
        Location accessLocation)
    {
        ...
        var isValid = ValidateHubTypeRuleCore(context, hubTypeSymbol, specialSymbols, accessLocation);
        ...
        Location accessLocation)
    {
        ...
        var isValid = ValidateReceiverTypeRuleCore(context, receiverTypeSymbol, specialSymbols, accessLocation);
