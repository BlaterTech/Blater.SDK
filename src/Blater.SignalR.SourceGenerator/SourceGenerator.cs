...
using Blater.SignalR.SourceGenerator.CodeAnalysis;
using Blater.SignalR.SourceGenerator.Templates;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp.Syntax;

namespace Blater.SignalR.SourceGenerator;
...
public sealed class SourceGenerator : IIncrementalGenerator
{
        ...
        SpecialSymbols specialSymbols)
    {
        ...
        foreach (var createHubProxyMethodSymbol in createHubProxyMethodSymbols)
        {
            ...
            var hubTypeSymbol = methodSymbol.TypeArguments[0];
        ...
        SpecialSymbols specialSymbols)
    {
        ...
        foreach (var registerMethodSymbol in registerMethodSymbols)
        {
            ...
            var receiverTypeSymbol = methodSymbol.TypeArguments[0];
