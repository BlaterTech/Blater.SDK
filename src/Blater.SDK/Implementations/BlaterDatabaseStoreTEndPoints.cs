...
public class BlaterDatabaseStoreTEndPoints(BlaterHttpClient client, string endpoint) : IBlaterDatabaseStoreT
{
    ...
    public Task<BlaterResult<IReadOnlyList<string>>> Query(BlaterQuery query)
    {
        ...
        return client.Post<string>($"{endpoint}/query", query);#1#
